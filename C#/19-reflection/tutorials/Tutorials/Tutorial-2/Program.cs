...
namespace Tutorial_2
{
    class Program
    {
        private static Dictionary<string, Type> _typesDictionary = new Dictionary<string, Type>()
        {
        ...
        static void Main(string[] args)
        {
            ...
            bool hasType = _typesDictionary.TryGetValue(choice, out Type type);
            if (!hasType) return;
